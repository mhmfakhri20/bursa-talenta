<form method="POST" action="{{ url('/reset-password') }}" id="reset-password-form" class="reset-password-form" autocomplete="off" role="main">
  @csrf
  <h1 class="a11y-hidden">Reset Password Form</h1>
  ...
  <div>
    <label class="label-password">
      <input type="password" class="text" name="password" placeholder="Password Baru" tabindex="2" required />
      <span class="required">Password Baru</span>
    </label>
  </div>

  <!-- Show Password Checkbox -->
  <input type="checkbox" name="show-password" class="show-password a11y-hidden" id="show-password" tabindex="4" />
  ...
  <div>
    <label class="label-password">
      <input type="password" class="text" name="password_confirmation" placeholder="Konfirmasi Password" tabindex="3" required />
