            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <div class="info-item d-flex aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div>
                            <h3>Alamat</h3>
                            <p>Jl. Telekomunikasi No. 1, Bandung Terusan Buahbatu - Bojongsoang, Sukapura, 
                                Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40257, Indonesia</p>
                        </div>
                    </div><!-- End Info Item -->
